    ...
    esp_lcd_panel_handle_t *ret_panel)
{
    ...
    nv3041a = (nv3041a_panel_t *)calloc(1, sizeof(nv3041a_panel_t));
    ...
    if (panel_dev_config->vendor_config) {
        nv3041a->init_cmds = ((nv3041a_vendor_config_t *)panel_dev_config->vendor_config)->init_cmds;
        nv3041a->init_cmds_size = ((nv3041a_vendor_config_t *)panel_dev_config->vendor_config)->init_cmds_size;
    }
...
#if ESP_IDF_VERSION < ESP_IDF_VERSION_VAL(5, 0, 0)
    nv3041a->base.disp_off = panel_nv3041a_disp_on_off;
#else
    ...
    *ret_panel = &(nv3041a->base);
    ...
    ESP_LOGI(TAG, "LCD panel create success, version: %d.%d.%d", ESP_LCD_NV3041A_VER_MAJOR, ESP_LCD_NV3041A_VER_MINOR,
             ESP_LCD_NV3041A_VER_PATCH);
